...
public class Game extends JPanel implements ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        int bgX = (score / 5) % background.getWidth(null);
        
        // background di chuyển
        // Draw the background twice to create a continuous loop
        g2.drawImage(background, -bgX, 0, null);
        g2.drawImage(background, background.getWidth(null) - bgX, 0, null);
        ...
        if (isRunning) {
            ...
            g2.drawString("Construction member: Thang-Khai-Vinh", Window.WIDTH - 300, Window.HEIGHT - 50);
        }
        g2.setColor(Color.black);
        g.setFont(new Font("Arial", 1, 20));
